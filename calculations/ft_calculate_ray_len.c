...
/*   Updated: 2020/04/29 18:17:46 by qli           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_calculate_ray_len(t_input *input)
{
	if (input->dda.side == 0)
	{
		input->dda.ray_len = (input->dda.map_x - input->ray_casting.pos_x
		+ (1 - input->dda.step_x) / 2) / input->ray_casting.ray_direction_x;
	}
	else
	{
