...
/*   Updated: 2020/04/24 20:06:16 by qli           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/* swapped input->sprite_data.sprite_height and with */
...
void 	ft_calculate_sprite_texture_x(t_input *input, int stripe)
{
	...
	/ 2 + input->sprite_data.sprite_screen_x)) * input->sprite.texture_height 
...
void 	ft_calculate_sprite_texture_y(t_input *input, int y)
{
	...
	input->sprite_data.texture_y = ((d * input->sprite.texture_width)
